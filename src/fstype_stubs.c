...
#elif defined(sun) || defined(__sun) || defined(__NetBSD__)
...
CAMLprim value unison_get_fstype(value path)
{
  ...
  CAMLreturn(caml_copy_string(buf.f_fstypename));
}


#elif defined(__FreeBSD__) || defined(__APPLE__) || defined(__OpenBSD__) || defined(__DragonFly__)
...
CAMLprim value unison_get_fstype(value path)
{
  ...
  CAMLreturn(caml_copy_string_of_utf16(fstype));
}


#else // defined(__linux) || defined(sun) || defined(__sun) || defined(__NetBSD__) || defined(__FreeBSD__) || defined(__APPLE__) || defined(__OpenBSD__) || defined(__DragonFly__) || defined(_WIN32)


CAMLprim value unison_get_fstype(value path)
{
  caml_unix_error(ENOSYS, "get_fstype", path);
}


#endif // defined(__linux) || defined(sun) || defined(__sun) || defined(__NetBSD__) || defined(__FreeBSD__) || defined(__APPLE__) || defined(__OpenBSD__) || defined(__DragonFly__) || defined(_WIN32)
